    ...
    <div class="pcoded-inner-navbar main-menu">
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="menu-item {{ Request::is('product') ? 'active' : '' }}">
                <a href="/product" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="ti-layers"></i><b>Product</b></span>
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="menu-item {{ Request::is('grafik') ? 'active' : '' }}">
                <a href="/grafik" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="fa fa-bar-chart"></i><b>Grafik</b></span>
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="menu-item {{ Request::is('galeri') ? 'active' : '' }}">
                <a href="/galeri" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="fa fa-picture-o"></i><b>Galeri</b></span>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">@yield('awal')</a>
                        </li>
                    </ul>
                </div>
            </div>
